...
import { calcBBS, BBS_ITEMS } from '@clinical/bbs';
...
interface BBSResult {
  ...
  meta: { classColor: 'red' | 'amber' | 'green'; items: number[] };
}

const BBS_SCORE_OPTIONS = [0, 1, 2, 3, 4] as const;
...
export function BBSForm({ patientId }: { patientId: string }) {
  ...
  function handleScore(itemIdx: number, score: number) {
    ...
    if (next.every(s => s !== null)) {
      const r = calcBBS({ items: next }) as BBSResult | null;
      setResult(r);
    } else {
      setResult(null);
    }
    ...
    <Screen padded={false} rootBackground={colors.primaryDark} safeEdges={['top', 'left', 'right']}>
      ...
      >
        ...
        <View style={styles.progressCard}>
          ...
          <View style={styles.progressHeader}>
            ...
            <View style={styles.progressScoreRow}>
              ...
              <Text style={styles.progressScoreUnit}>/56</Text>
            </View>
          </View>
        ...
        <Card style={styles.itemsCard}>
          {(BBS_ITEMS as string[]).map((itemName: string, idx: number) => {
        ...
        {allScored && result !== null ? (
          <>
            <View style={styles.resultCard}>
              <Text style={styles.resultMicroLabel}>BBS RESULT</Text>
              <View style={styles.resultValueRow}>
                ...
                <View style={[
                  ...
                  { backgroundColor: BBS_COLOR_MAP[result.meta.classColor] ?? colors.muted },
                ]} />
              </View>
