...
import type { FRInput } from './types';
import { colors, spacing, typography, radii } from '../../../theme/tokens';

interface FRScreenProps {
  input: FRInput;
  onChange: (input: FRInput) => void;
  onNext: () => void;
  onBack: () => void;
  canProceed: boolean;
      ...
      >
        <Card style={styles.patientCard}>
          ...
          <View style={styles.stepPill}>
            <Text style={styles.stepPillText}>3 OF 4</Text>
          </View>
        </Card>

        <View style={styles.instructionCard}>
          <Text style={styles.instructionLabel}>FUNCTIONAL REACH</Text>
          <Text style={styles.instructionText}>Maximum forward reach from standing</Text>
        </View>
        ...
        <Pressable
          ...
          accessibilityLabel="Unable to stand or reach"
        >
