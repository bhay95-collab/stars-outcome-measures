      ...
      >
        <Card style={styles.patientCard}>
          ...
          <View style={styles.stepPill}>
            <Text style={styles.stepPillText}>4 OF 4</Text>
          </View>
        </Card>

        <View style={styles.instructionCard}>
          <Text style={styles.instructionLabel}>TIMED STATIC STANCE</Text>
          <Text style={styles.instructionText}>Feet together · eyes closed</Text>
        </View>
        ...
        <Pressable
          ...
          accessibilityLabel="Unable to complete static stance"
        >
        ...
        >
          <Text style={styles.nextBtnText}>View Results</Text>
        </Pressable>
      </ScrollView>
    </Screen>
  );
