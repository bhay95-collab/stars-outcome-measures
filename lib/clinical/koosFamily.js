// KOOS/HOOS/HAGOS shared scoring engine (Roos instrument family, koos.nu)
...
export const KF_OPTIONS = {
  ...
  // HAGOS frequency items end the scale at "All the time" rather than "Always".
  freqAllTime: ['Never', 'Rarely', 'Sometimes', 'Often', 'All the time'],
}
