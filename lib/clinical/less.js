...
// drop-vertical-jump is scored for movement errors across 17 items; a HIGHER
// error count = WORSE landing mechanics (lower = better).
//
// This engine records the total error count (0–17). LESS < 5 marks good landing
// mechanics; the < 5 cut-off derives from Padua's work (Padua 2009 development;
// prospective injury-risk association in the JUMP-ACL cohort, Padua 2015, AJSM
// 43:2603) — NOT from Grindem 2016, whose RTS battery did not include the LESS.
