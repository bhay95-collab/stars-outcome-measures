...
export const CONDITION_OPTIONS = [
  ...
  'Hip — OA / Replacement', 'Shoulder Pain / Rotator Cuff',
...
export const DIAG_RECS = {
  ...
  'Low Back Pain':                ['BPFS', 'NPRS', 'PSFS', 'FTSTS'],
  'Neck Pain / Whiplash':         ['NPRS', 'PSFS'],
  'Knee — ACL Reconstruction':    ['KOOS', 'NPRS', 'PSFS'],
  ...
  'Ankle Sprain / Instability':   ['FAAM', 'NPRS', 'PSFS'],
  'Achilles Tendinopathy':        ['FAAM', 'NPRS', 'PSFS'],
  'MSK — Other':                  ['NPRS', 'PSFS'],
}
