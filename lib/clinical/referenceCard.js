...
const EXTRA_NOTES = {
  ...
  'HAGOS':   'Hip/groin. 6 subscales, never totalled. No anchored MCID - change vs per-subscale MDC (18-34 pts).',
  'OMAS':    'Ankle fracture. /100, higher = better. Poor <=30 / fair / good / excellent >=91. MCID ~12.5 pts.',
  'HHS':     'Hip OA/THA clinician composite. /100, higher = better. Poor <70 / fair / good / excellent >=90. MCID ~16 pts post-THA.',
  'CSI':     'Central sensitization screen. /100, higher = worse. Subclinical/mild/moderate/severe/extreme bands; >=40 = cutoff. No MCID/MDC established. Part B (history) not scored.',
  'QuadLSI': 'ACL RTS. Involved/uninvolved x100. RTS cut-off >=90% (Grindem 2016); 80% late-rehab milestone.',
  'HopBattery': 'ACL RTS. 4 hops, each LSI >=90% to pass (Reid 2007/Grindem 2016). Limiting hop is the score.',
  'LESS':    'ACL RTS landing screen. Errors /19, lower = better. <5 = good mechanics (Padua 2009/2015).',
}
