...
export const MEASURES = {
  ...
  'HHS': {
    ...
    chart: {
      ...
      yMax: 100,
      thresholds: [
        // Harris 1969 bands: poor <70, fair 70–79, good 80–89, excellent 90–100
        { value: 69,  label: 'Poor (<70)',          color: '#a13b30' },
        { value: 79,  label: 'Fair (70–79)',        color: '#8a6512' },
        { value: 89,  label: 'Good (80–89)',        color: '#3f8a5f' },
        { value: 100, label: 'Excellent (90–100)',  color: '#2a6b4f' },
      ],
    },
  },
  ...
  'CSI': {
    ...
    primaryUnit: '/100',
    higherIsBetter: false,
    // No published MCID/MDC exists (Mayer 2012; Neblett 2013; Neblett 2018).
    mcidKey: null,
    chart: {
      yMin: 0,
      yMax: 100,
      thresholds: [
        // Neblett 2013 (Pain Pract 13:359-69) severity bands; 40 = clinical cutoff.
        { value: 29, label: 'Subclinical (0–29)', color: '#2a6b4f' },
        { value: 39, label: 'Mild (30–39)',       color: '#3f8a5f' },
        { value: 49, label: 'Moderate (40–49)',   color: '#8a6512' },
        { value: 59, label: 'Severe (50–59)',     color: '#a13b30' },
        { value: 100, label: 'Extreme (60–100)',  color: '#7e2c24' },
      ],
    },
  },
  ...
  'ACLSigns': {
    id: 'ACLSigns',
    name: 'ACL Clinical Signs (Extension & Effusion)',
    category: 'performance',
    domains: ['msk'],
    primaryUnit: '/2',
    higherIsBetter: true,
    mcidKey: null,
    primaryLabel: 'Gate signs met',
    chart: {
      yMin: 0,
      yMax: 2,
      thresholds: [
        // Both signs (full extension + effusion trace–zero) gate the early
        // phases (van Melick 2016; Sturgill 2009)
        { value: 1, label: 'Signs outstanding', color: '#a13b30' },
        { value: 2, label: 'Both signs met', color: '#2a6b4f' },
      ],
    },
  },
  ...
  'LESS': {
    ...
    chart: {
      ...
      yMax: 19,
      thresholds: [
        // RTS screen LESS < 5 = good landing mechanics (Padua 2009; Padua 2015)
        { value: 4,  label: 'Good (<5 errors)',     color: '#2a6b4f' },
        { value: 6,  label: 'Moderate (5–6)',       color: '#8a6512' },
        { value: 19, label: 'Poor (>6 errors)',     color: '#a13b30' },
      ],
    },
  },
