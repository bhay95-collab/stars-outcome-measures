...
export const MEASURES = {
  ...
  'COVS': {
    id: 'COVS',
    name: 'Co-operative Ordinal Variance Scale',
    category: 'performance',
    primaryUnit: '/91',
    higherIsBetter: true,
    mcidKey: 'covs',
  ...
  'BOOMER': {
    ...
    chart: {
      ...
      yMax: 12,
      thresholds: [
        { value: 4,  label: 'High fall risk (<4)', color: '#b5451b' },
        { value: 8,  label: 'Moderate',            color: '#a05c00' },
        { value: 12, label: 'Low risk',            color: '#2d6a4f' },
      ],
    },
  },
