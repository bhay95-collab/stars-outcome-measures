...
export const MEASURES = {
  ...
  'ACLSigns': {
    ...
    higherIsBetter: false,
    mcidKey: null,
    primaryLabel: 'Effusion grade',
    chart: {
      yMin: 0,
      yMax: 4,
      thresholds: [
        // Modified stroke test: trace–zero passes the gate (Sturgill 2009)
        { value: 1, label: 'Trace–zero (gate level)', color: '#2a6b4f' },
        { value: 4, label: 'Effusion present (1+–3+)', color: '#a13b30' },
      ],
    },
  },
