...
//
// Entry shape: { thresh, unit, hib, mdc?, byCondition? }
...
//                  Unlisted conditions fall back to the default values.
...
export function resolveMCIDEntry(mcidKey, condition) {
  ...
  const override = condition ? entry.byCondition?.[condition] : null
