...
export const MCID_VALS = {
  ...
  // OMAS (higher = better, single 0–100 total). Anchored MCID exists, so this
  // uses standard "MCID met" labels (unlike the MDC-floor measures above).
  // 12.5 = ROC anchor at 3–6 mo; published range 10.5–15 across method/follow-up
  // (Lehnert 2022, Arch Orthop Trauma Surg; MDC ≈4.7–5.2).
  'omas':           { thresh: 12.5, unit: 'pts', hib: true },
  // Harris Hip Score (higher = better, clinician composite 0–100). Anchored
  // MCII post-primary-THA 15.9–18 points depending on method (Singh 2016,
  // BMC Musculoskelet Disord 17:256, n=2667) — 16 used as the change floor.
  'hhs':            { thresh: 16, unit: 'pts', hib: true },
}
...
export const MCID_DATA = {
  ...
  'Ankle Fracture':               'OMAS: single 0–100 total (higher = better); bands poor ≤30 / fair 31–60 / good 61–90 / excellent 91–100. Anchored MCID ≈12.5 pts (ROC 3–6 mo; published range 10.5–15, Lehnert 2022); MDC ≈4.7–5.2 | NPRS MCID 2 pts | LEFS MCID 9 pts',
