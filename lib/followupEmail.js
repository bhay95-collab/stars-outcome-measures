...
export function buildFollowUpEmail({ to, publicUrl, expiresAt, measureId } = {}) {
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; color: #1c2b36; line-height: 1.5;">
      ...
      <p><a href="${escapeHtml(publicUrl)}" style="color: #094b8a;">Open secure questionnaire</a></p>
      <p><strong>Link expires:</strong> ${escapeHtml(expiryLabel)}</p>
      <p style="color: #5f6e6d; font-size: 13px;">
