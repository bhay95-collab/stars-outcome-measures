...
export const FOLLOWUP_REQUEST_SELECT = 'id, user_id, patient_id, measure_id, source_assessment_id, completed_assessment_id, recipient_email, sent_at, email_status, email_provider_message_id, email_error, last_email_attempt_at, status, due_at, expires_at, created_at, completed_at, cancelled_at, reviewed_at'
