...
export const FOLLOWUP_REQUEST_SELECT = 'id, user_id, patient_id, measure_id, source_assessment_id, completed_assessment_id, status, due_at, expires_at, created_at, completed_at, cancelled_at'
